...
function LogAddition(target, methodName, descriptor) {
    var originalMethod = descriptor.value;
    descriptor.value = function (a, b) {
        var result = originalMethod.apply(this, [a, b]);
        console.log("Addition: ".concat(a, " + ").concat(b, " = ").concat(result));
        return result;
    };
    return descriptor;
}
